...
namespace IO.Swagger.Api
{
    ...
    public interface IBuildingApi : IApiAccessor
    {
        ...
        /// <param name="id">The identifier of the building.</param>
        /// <returns>ApiResponse of string</returns>
        ApiResponse<string> ApiV11BuildingsByIdFinancialGetWithHttpInfo (Guid? id);
        /// <summary>
        ...
        /// <param name="id">The identifier of the building.</param>
        /// <returns>Task of string</returns>
        System.Threading.Tasks.Task<string> ApiV11BuildingsByIdFinancialGetAsync (Guid? id);
        ...
        /// <param name="id">The identifier of the building.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        System.Threading.Tasks.Task<ApiResponse<string>> ApiV11BuildingsByIdFinancialGetAsyncWithHttpInfo (Guid? id);
        /// <summary>
        /// Gets a building by its identifier.
        /// </summary>
        /// <remarks>
    ...
    public partial class BuildingApi : IBuildingApi
    {
        ...
        /// <returns></returns>
        public BuildingApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="id">The identifier of the building.</param>
        /// <returns>string</returns>
        public string ApiV11BuildingsByIdFinancialGet (Guid? id)
        {
             ApiResponse<string> localVarResponse = ApiV11BuildingsByIdFinancialGetWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The identifier of the building.</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > ApiV11BuildingsByIdFinancialGetWithHttpInfo (Guid? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="id">The identifier of the building.</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> ApiV11BuildingsByIdFinancialGetAsync (Guid? id)
        {
             ApiResponse<string> localVarResponse = await ApiV11BuildingsByIdFinancialGetAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">The identifier of the building.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> ApiV11BuildingsByIdFinancialGetAsyncWithHttpInfo (Guid? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling BuildingApi->ApiV11BuildingsByIdFinancialGet");
