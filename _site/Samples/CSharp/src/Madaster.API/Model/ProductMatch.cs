...
namespace Madaster.API.Model
{
    ...
    public partial class ProductMatch :  IEquatable<ProductMatch>, IValidatableObject
    {
        ...
        protected ProductMatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductMatch" /> class.
        /// </summary>
        /// <param name="value">The value that this product will match to (required).</param>
        /// <param name="matchType">The type of match to look for.</param>
        public ProductMatch(string value = default(string), MatchTypeEnum? matchType = default(MatchTypeEnum?))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for ProductMatch and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        /// </summary>
        /// <value>The value that this product will match to</value>
