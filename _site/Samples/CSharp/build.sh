...
${nuget_cmd} install src/Madaster.API/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Madaster.API.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Madaster.API.dll \
-recurse:'src/Madaster.API/*.cs' \
-doc:bin/Madaster.API.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Madaster.API.dll was created successfully"
fi
