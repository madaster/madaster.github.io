 ...
 * Download the <a href="/files/en/Madaster Materials.xlsx" target="_blank">Madaster Material List</a> - it displays the materials (in English language) that are available in the Madaster database, including their UID's.
 * Download the <a href="/files/en/Epea_Generic.xlsx" target="_blank">EPEA Generic List</a> - it displays the products (in English language) that are available in the EPEA Generic database, including their UID's and search criteria.
