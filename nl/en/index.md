 ...
 * Download the latest <a href="https://info.kubusinfo.nl/login?ReturnUrl=%2fsupport%2fmadaster" target="_blank">Archicad IFC ExportTranslator</a> - this contains the optimal export settings for an IFC file from Archicad to the Madaster platform (available for Dutch KeyMembers). Click <a href="https://helpcenter.kubusinfo.nl/portal/nl/kb/articles/ifc-modelexport-voor-madaster#Verwijzigingen" target="_blank" >here</a> instructions and tips.
