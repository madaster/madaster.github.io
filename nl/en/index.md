 ...
 * Download the <a href="/files/en/EPEA Generic.xlsx" target="_blank">EPEA Generic List</a> - it displays the products (in English language) that are available in the EPEA Generic database, including their UID's and search criteria.
