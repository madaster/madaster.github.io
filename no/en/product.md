...
redirect_from:
  - /no/en/view-product
  - /no/en/view-product-searchcriteria
  - /no/en/view-product-files
  - /no/en/view-product-finance
  - /no/en/edit-product
  - /no/en/edit-product-searchcriteria
  - /no/en/edit-product-files
  - /no/en/edit-product-finance
  - /no/en/new-product
---
