...
> Hinweis: Da sich dieses Feature noch in der **Pilotphase** befindet, stellen Sie bitte in Absprache mit unserem Supportteam sicher, dass es für Ihren Account freigeschalten wurde.
...
|Externe ID |Optional |Hier können Sie den Materialien und Produkten eine individuelle Kennung zuweisen. |
|**Bild** |**Empfohlen** |Bilder können direkt in der Zelle eingefügt oder in Form einer URL hinzugefügt werden. Ein späterer separater Upload ist ebensfall möglich. |
...
4. über die Schaltfläche **Bilder importieren <iconify-icon inline icon='mdi-image-multiple'/>** mehrere Bilder gleichzeitig hochladen. <br>Für diese Variante beachten Sie bitte, dass die Dateinamen eindeutig sind, um die automatische Zuordnung zu ermöglichen. 
 <figure><img src="/assets/images_GER/IR Namensmuster Bilder.png" alt="Übersicht Namensmuster für Bilderbenennung"><figcaption>Übersicht Namensmuster für Bilderbenennung</figcaption></figure>
...
1. Haken Sie dazu die Box vor dem oder den jeweiligen Produkten an <iconify-icon inline icon='mdi-checkbox-marked'/> und eine Toolbar wird oberhalb der Produktliste erscheinen.
2. Wählen Sie <iconify-icon inline icon='mdi-publish'/> (Veröffentlichen).
3. Wählen Sie, ob die Produkte **nur innerhalb des Projekts, des Ordners, Ihres Accounts oder für alle Benutzer der Plattform** sichtbar sein sollen.
...
Um mittels Madaster Match verfügbare Produkte und Materialien einzusehen und vorgeschlagen bekommen zu können, wählen Sie bitte auf **Accountebene** den **Match** Tab. 
...
* Lassen Sie sich **Passende Produkte anzeigen <iconify-icon inline icon='mdi-magnify-scan'/>**.
